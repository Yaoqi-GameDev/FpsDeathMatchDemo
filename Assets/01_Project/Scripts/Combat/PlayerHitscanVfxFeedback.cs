...
{
    /// <summary>
    /// 玩家专用：订阅同物体上 <see cref="FpsHitscanWeapon"/> 的 <c>ShotResolved</c>，播放命中特效。
    /// 资源示例：Infima <c>P_IMP_Concrete</c>。挂在与 <see cref="FpsHitscanWeapon"/> 同一物体上。
    /// </summary>
    [DisallowMultipleComponent]
    public sealed class PlayerHitscanVfxFeedback : MonoBehaviour
    {
